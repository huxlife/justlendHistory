...
function JustLendLiquidations() { // Renamed from App
  ...
  return (
    <div className="justlend-liquidations-container"> {/* Changed class for scoping */}
        {/* Title removed from here, will be in the main App tab */}
...
export default JustLendLiquidations; // Export the renamed component
